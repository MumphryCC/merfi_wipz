...
const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      "/placeholder.svg?height=280&width=700&text=Workout+Dashboard+Stats",
      "/placeholder.svg?height=280&width=700&text=Exercise+Library+Grid",
      "/placeholder.svg?height=280&width=700&text=Progress+Tracking+Charts",
      "/placeholder.svg?height=280&width=700&text=Nutrition+Log+Interface",
      "/placeholder.svg?height=280&width=700&text=Goal+Setting+Panel",
      "/placeholder.svg?height=280&width=700&text=Social+Features+Feed",
      "/placeholder.svg?height=280&width=700&text=Wearable+Device+Sync",
      "/placeholder.svg?height=280&width=700&text=Workout+Timer+Screen",
      "/placeholder.svg?height=280&width=700&text=Achievement+Badges",
      "/placeholder.svg?height=280&width=700&text=Weekly+Progress+Report",
    ],
    fullDescription:
      "A comprehensive fitness tracking mobile application with workout planning, progress monitoring, nutrition logging, and social features.",
    keyFeatures: [
      "Workout Dashboard",
      "Exercise Library",
      "Progress Tracking",
...
const achievements: Achievement[] = [
  // Online Courses
  {
    ...
    category: "course",
    image: "/placeholder.svg?height=300&width=400&text=React+Certificate",
  ...
  },
  {
    ...
    category: "course",
    image: "/placeholder.svg?height=300&width=400&text=JS+Certificate",
    description: "Advanced JavaScript programming concepts including ES6+, async/await, and design patterns",
    date: "2024",
  ...
  },
  {
    ...
    category: "course",
    image: "/placeholder.svg?height=300&width=400&text=Node+Certificate",
  ...
  },
  {
    ...
    category: "course",
    image: "/placeholder.svg?height=300&width=400&text=DB+Certificate",
    description: "Database design principles, SQL optimization, and management best practices",
    date: "2023",
  ...
  },
  {
    ...
    category: "course",
    image: "/placeholder.svg?height=300&width=400&text=UX+Certificate",
    description: "User interface and experience design principles and methodologies",
    date: "2024",
  ...
  // Seminars and Training
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=Tech+Summit",
  ...
  },
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=Agile+Workshop",
  ...
  },
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=Cloud+Computing",
  ...
  },
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=Mobile+Dev",
  ...
  },
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=Web+Security",
  ...
  },
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=DevOps",
  ...
  },
  {
    ...
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=AI+ML",
    description: "Artificial intelligence, machine learning algorithms, and practical applications",
    date: "2024",
    issuer: "AI Conference",
  },
  {
    id: 15,
    title: "Blockchain Technology Workshop",
    category: "seminar",
    image: "/placeholder.svg?height=300&width=400&text=Blockchain",
