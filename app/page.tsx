...
const projects: Project[] = [
  ...
  },
  {
    ...
    techStack: ["Figma"],
    Globe: "https://www.figma.com/proto/UPEwmwbxLxD7zlCLXLDYw0/BiyaHero?node-id=3-5149&p=f&t=IGxoqqYa99QfnAI3-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=3%3A5149&show-proto-sidebar=1&fbclid=IwY2xjawL20b9leHRuA2FlbQIxMABicmlkETFnSHNOYjJPYUUyUmRQSHVuAR5x9IlLkIba33C4KC5DuVO5_XWIRDnHynj9LdffhCJpNFLVWhgQsC-NmGZtuA_aem_QkV4kThTHbRws2S0se694w",
    images: [
  ...
  },
  {
    ...
    Globe: "https://drive.google.com/file/d/1CeUIl7y9ZXhN2JH9BGrkgOlWCb3n1yCg/view?fbclid=IwY2xjawL20h1leHRuA2FlbQIxMABicmlkETFnSHNOYjJPYUUyUmRQSHVuAR5N_VAxHkNfau6QuD_8dNDw0uHfQeSv2wEQGmq7w-560CPWfzLxXP4yL8RPAg_aem_R6KDbRV9e4930x29QL5eDA",
    images: [
  ...
  },
  {
    ...
    techStack: ["Logism"],
    Globe: "https://drive.google.com/file/d/1JjfHoEcNYG_c3tF8072_1dqcSXYfhDzW/view?usp=sharing",
    images: [
  ...
  },
  {
    ...
    techStack: ["Figma"],
    Globe: "https://drive.google.com/file/d/15oHcKXEFQE32ARbJ4nDbbv0lFFdRpEvA/view?usp=sharing",
    images: [
  ...
  },
  {
    ...
    Globe: "https://drive.google.com/file/d/1YnTiTyg9VoOfHppgA3oOBZNs2GutVlx6/view?usp=sharing",
    images: [
  ...
  },
  {
    ...
    Globe: "https://drive.google.com/file/d/13ikWdbhcB47ysxUE7FHX-sWDTRP-kGON/view?usp=sharing",
    images: [
...
const achievements: Achievement[] = [
  ...
  {
    id: 6,
    title: "Debugging your Future: Understanding Labor and Employment",
    category: "seminar",
    image: "/sem10.png?height=300&width=400&text=Tech+Summit",
    description: "This seminar helped us understand the world of work and jobs. We learned important things about labor and employment to better prepare for our future careers.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 7,
    title: "Debugging your Future: Understanding Career Growth in Tech",
    category: "seminar",
    image: "/sem9.png?height=300&width=400&text=Cybersecurity",
    description: "This seminar helped us understand how to plan and grow our careers in the technology field. We learned about different paths and strategies to succeed in tech.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 8,
    title: "GenAI: Revolutionizing Technology and Society",
    category: "seminar",
    image: "/sem8.png?height=300&width=400&text=Mobile+Dev",
    description: "This seminar introduced us to Generative AI and how it's changing technology and society. We learned about its impact and how it's creating new possibilities.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 9,
    title: "Beyond the Algorithm: Ethical AI Use in Learning",
    category: "seminar",
    image: "/sem7.png?height=300&width=400&text=Agile+Workshop",
    description: "This seminar taught us about using Artificial Intelligence (AI) in education in a responsible and fair way. We learned to look beyond just the technical parts of AI and focus on its ethical use when we are learning.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 10,
    title: "Code, Design, Deploy: What Every Developer Should Know",
    category: "seminar",
    image: "/sem6.png?height=300&width=400&text=Cloud+Computing",
    description: "This seminar taught us the essential things every software developer should know. We learned about writing code, designing software, and getting it ready for use.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 11,
    title: "Automate to Innovate: Enhancing Software Testing",
    category: "seminar",
    image: "/sem5.png?height=300&width=400&text=Data+Science",
    description: "This seminar taught us about making software testing automatic so we can be more creative and efficient. We learned how to improve the process of checking software for problems.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 12,
    title: "Debugging the Self: Overcoming Challenges in Personality Development",
    category: "seminar",
    image: "/sem4.png?height=300&width=400&text=Web+Security",
    description: "This seminar helped us understand how to improve our personalities. We learned ways to overcome personal challenges and grow as individuals.",
    date: "2025",
    issuer: "Participant",
  },
  {
    id: 13,
    title: "Debugging the Self: Overcoming Challenges in Communication Skills",
    category: "seminar",
    image: "/sem3.png?height=300&width=400&text=DevOps",
    description: "This seminar helped us learn how to improve our communication skills. It taught us how to fix our personal challenges and become better at talking and interacting with others.",
    date: "2025",
    issuer: "Participant",
  },
  {
    ...
    description: "This seminar teaches people how to succeed when things are difficult. It helps them learn how to handle their time better and deal with stress in today's busy world.",
    date: "2025",
  ...
  },
  {
    ...
    description: "This seminar is all about how to be a great leader who can motivate and involve a team. It teaches you ways to make your team members feel excited and dedicated to their work.",
    date: "2025",
    issuer: "Event Organizer",
  },
]
